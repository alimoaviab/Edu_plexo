  ...
  const sections: ProfileSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'question-bank', label: 'Question Bank', description: 'Question repository', icon: 'book', accent: 'primary', href: '/(admin)/module/question-bank' },
        ...
        { key: 'chapters', label: 'Chapters', description: 'Chapter catalog', icon: 'book', accent: 'primary', href: '/(admin)/module/chapters' },
