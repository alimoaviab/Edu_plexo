    ...
    return (
      <ScreenContainer scroll>
        <Header
          ...
          right={<ManageButton label="Manage" icon="settings" onPress={() => router.push('/(owner)/module/teachers' as never)} />}
        />
  ...
  return (
    <ScreenContainer scroll>
      <Header
        ...
        right={<ManageButton label="Add" onPress={() => router.push('/(owner)/module/teachers' as never)} />}
      />
