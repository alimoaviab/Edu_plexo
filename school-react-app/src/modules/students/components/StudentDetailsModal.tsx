...
export function StudentDetailsModal({ isOpen, studentId, onClose }: StudentDetailsModalProps) {
  ...
  return (
    <DetailsPanel
      isOpen={isOpen}
      onClose={onClose}
      title={student ? `${student.first_name} ${student.last_name || ""}` : "Student Details"}
      subtitle={student ? `Roll: ${student.admission_no} • Class: ${student.class_id} (${student.section || "N/A"})` : "Loading information..."}
    >
      <div className="flex flex-col gap-6">
        {/* Tab Selection */}
        <div className="border-b border-slate-100 flex gap-4 bg-white/95 backdrop-blur-md -mt-6 -mx-6 px-6 py-1.5 sticky top-0 z-10">
                    ...
                    <div className="p-5 rounded-2xl border border-slate-100 bg-slate-50/30 flex flex-col justify-between">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center text-sm border-b border-slate-100 pb-2">
                          ...
                          <span className="font-bold text-blue-600">{(student as any).email || "No email"}</span>
                        </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="p-4 bg-blue-50/50 border border-blue-100 rounded-2xl">
                      ...
                      <h4 className="text-lg font-black text-blue-900 mt-1">Rs. {feeMetrics.totalInvoiced.toLocaleString()}</h4>
                    </div>
                    <div className="p-4 bg-emerald-50/50 border border-emerald-100 rounded-2xl">
                      <p className="text-[9px] font-black text-emerald-500 uppercase tracking-widest">Total Paid</p>
                      <h4 className="text-lg font-black text-emerald-900 mt-1">Rs. {feeMetrics.totalPaid.toLocaleString()}</h4>
                    </div>
                    <div className="p-4 bg-rose-50/50 border border-rose-100 rounded-2xl">
                      ...
                      <h4 className="text-lg font-black text-rose-900 mt-1">Rs. {feeMetrics.balance.toLocaleString()}</h4>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-indigo-50/50 border border-indigo-100 rounded-2xl flex flex-col justify-between">
                      ...
                      <h4 className="text-lg font-black text-indigo-900 mt-1">{attendanceMetrics.percentage}%</h4>
                    </div>
                    <div className="p-4 bg-emerald-50/50 border border-emerald-100 rounded-2xl flex flex-col justify-between">
                      ...
                      <h4 className="text-lg font-black text-emerald-900 mt-1">{attendanceMetrics.present} days</h4>
                    </div>
                    <div className="p-4 bg-rose-50/50 border border-rose-100 rounded-2xl flex flex-col justify-between">
                      ...
                      <h4 className="text-lg font-black text-rose-900 mt-1">{attendanceMetrics.absent} days</h4>
                    </div>
                    <div className="p-4 bg-amber-50/50 border border-amber-100 rounded-2xl flex flex-col justify-between">
                      ...
                      <h4 className="text-lg font-black text-amber-900 mt-1">{attendanceMetrics.leave} days</h4>
                    </div>
                  </div>
