/**
 * Certificate Edit Page — Edit an existing certificate template.
 */
...
export function CertificateEditPage() {
  ...
  useEffect(() => {
    if (templateState.data) {
      const t = templateState.data;
      setName(t.name || "");
      setCertificateTitle(t.type || "");
            ...
            <div className="relative w-full h-full p-6 md:p-10 flex flex-col">
              ...
              <div className="text-center mb-4 relative z-10">
                <div className="flex items-center justify-center mb-2">
                  <div className="h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center text-white text-sm font-bold">
                    {(resolvedSchoolName || "S").charAt(0).toUpperCase()}
                  </div>
                </div>
                <h3 className="text-base md:text-lg font-black text-slate-900">{resolvedSchoolName || "School Name"}</h3>
              </div>
              ...
              <div className="flex-1 relative z-10 overflow-hidden">
                <p className="text-[10px] md:text-xs text-slate-700 leading-relaxed text-center max-w-md mx-auto">
                  {bodyText || "Certificate body text will appear here..."}
                </p>
              </div>
