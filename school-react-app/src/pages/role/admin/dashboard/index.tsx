        ...
        <div className="space-y-4 lg:col-span-2">
           ...
           {/* Quick Insights Chips */}
              ...
              {(data?.alerts || []).map((alert, i) => (
                <Link key={i} to={alert.link} className={`flex items-center gap-1.5 px-3 py-1 rounded-full border text-[9px] font-bold normal-case  transition-all hover:scale-[1.02] ${
              ...
              <div className="relative ml-2 pl-4 border-l-2 border-slate-100">
                  {(data?.alerts || []).filter(a => a.severity === "info" && a.title.includes("Exam")).length ? (
                    ...
                    <div className="py-4 text-center">
                       ...
                       <Link to="/admin/exams?action=new" className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-lg border border-slate-200 text-[10px] font-bold normal-case  text-slate-600 hover:border-blue-300 hover:text-blue-600 transition-all">
