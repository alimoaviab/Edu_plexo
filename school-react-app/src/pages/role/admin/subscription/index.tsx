    ...
    <SchoolShell eyebrow="Administration" title="Subscription Status">
      <div className="max-w-5xl mx-auto space-y-8 pb-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          {/* Owner billing link commented out */}
          {/* {isOwner && (
            <Link
          ...
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div className="space-y-1.5 flex-1 min-w-0">
              <h2 className="text-sm sm:text-base font-bold text-slate-900 flex items-center gap-2">
                <span>School Subscription Details</span>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                Your school's subscription plan, student capacity limit, billing renewals, and feature packages.
              </p>
              <p className="text-xs text-slate-500 font-medium pt-1">
                Need to add more students or unlock additional premium modules? Please contact your administrator or support.
              </p>
            </div>
          </div>
        </div>
