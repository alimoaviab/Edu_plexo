...
import { PTB_CLASS2_MATHEMATICS, getAllChapters } from "@/data/syllabus/ptb-class2-mathematics";

/**
 * Class 2 Mathematics Syllabus Demo Page
 * 
 * Demonstrates the Chapter Selector with PTB Class 2 Mathematics.
 */
...
export function SyllabusClass2MathDemoPage() {
  ...
  return (
    <SchoolShell eyebrow="Question Papers" title="Class 2 Mathematics - Chapter Selection">
      <div className="space-y-6">
        ...
        <div className="p-4 bg-blue-50/50 border border-blue-100/50 rounded-xl">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[11px] font-bold text-blue-900 mb-1">Class 2 Mathematics Syllabus</p>
              <p className="text-[10px] text-blue-700 leading-relaxed">
                This syllabus includes all chapters with exercises and review exercises from PTB Class 2 Mathematics.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              <ChapterSelector
                units={PTB_CLASS2_MATHEMATICS}
                selectedChapters={selectedChapters}
                onSelectionChange={setSelectedChapters}
                title="PTB Class 2 Mathematics Syllabus"
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-bold text-slate-900">{PTB_CLASS2_MATHEMATICS.length}</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
