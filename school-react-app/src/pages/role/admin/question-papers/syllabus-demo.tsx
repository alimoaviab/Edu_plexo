 ...
 * Syllabus Demo Page
 * 
 * Demonstrates the Chapter Selector component with PTB Class 1 English syllabus.
 * This shows how teachers can select chapters for paper generation.
 */
...
export function SyllabusDemoPage() {
  ...
  return (
    <SchoolShell eyebrow="Question Papers" title="Chapter Selection Demo">
      <div className="space-y-6">
        ...
        <div className="p-4 bg-blue-50/50 border border-blue-100/50 rounded-xl">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[11px] font-bold text-blue-900 mb-1">Chapter Selection System</p>
              <p className="text-[10px] text-blue-700 leading-relaxed">
                This component allows teachers to select specific chapters for paper generation, syllabus tracking, and progress monitoring. 
                The system supports unit-wise selection, review sections, and the English B section separately.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              <ChapterSelector
                ...
                title="PTB Class 1 English Syllabus"
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-bold text-slate-900">{PTB_CLASS1_ENGLISH.length}</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
