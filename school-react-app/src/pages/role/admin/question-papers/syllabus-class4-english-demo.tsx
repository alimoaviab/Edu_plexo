...
export function SyllabusClass4EnglishDemoPage() {
  return <Navigate to="/admin/question-papers/generator?syllabus=ptb&class=FOUR&subject=English" replace />;
=======
...
import { PTB_CLASS4_ENGLISH, getAllChapters } from "@/data/syllabus/ptb-class4-english";
...
export function SyllabusClass4EnglishDemoPage() {
  ...
  return (
    <SchoolShell eyebrow="Question Papers" title="Class 4 English - Chapter Selection">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[12px] text-slate-500 mt-0.5">PTB → Class 4 → English</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              <ChapterSelector
                units={PTB_CLASS4_ENGLISH}
                selectedChapters={selectedChapters}
                onSelectionChange={setSelectedChapters}
                title="PTB Class 4 English Syllabus"
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-bold text-slate-900">{PTB_CLASS4_ENGLISH.length}</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
