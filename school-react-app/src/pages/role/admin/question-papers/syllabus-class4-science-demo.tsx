...
export function SyllabusClass4ScienceDemoPage() {
  return <Navigate to="/admin/question-papers/generator?syllabus=ptb&class=FOUR&subject=General%20Science" replace />;
=======
...
import { PTB_CLASS4_GENERAL_SCIENCE, getAllChapters } from "@/data/syllabus/ptb-class4-general-science";
...
export function SyllabusClass4ScienceDemoPage() {
  ...
  return (
    <SchoolShell eyebrow="Question Papers" title="Class 4 General Science - Chapter Selection">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[12px] text-slate-500 mt-0.5">PTB → Class 4 → General Science</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              <ChapterSelector
                units={PTB_CLASS4_GENERAL_SCIENCE}
                selectedChapters={selectedChapters}
                onSelectionChange={setSelectedChapters}
                title="PTB Class 4 General Science Syllabus"
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-bold text-slate-900">{PTB_CLASS4_GENERAL_SCIENCE.length}</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
