...
import { PTB_CLASS1_ISLAMIAT, getAllChapters } from "@/data/syllabus/ptb-class1-islamiat";

/**
 * Islamiat Syllabus Demo Page
 * 
 * Demonstrates the Chapter Selector with PTB Class 1 Islamiat (Urdu).
 */
...
export function SyllabusIslamiatDemoPage() {
  ...
  return (
    <SchoolShell eyebrow="Question Papers" title="Islamiat - Chapter Selection">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-blue-700 leading-relaxed">
                ...
                All chapters from PTB Class 1 Islamiat are included with exact Urdu text.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              <ChapterSelector
                units={PTB_CLASS1_ISLAMIAT}
                selectedChapters={selectedChapters}
                onSelectionChange={setSelectedChapters}
                title="PTB Class 1 Islamiat Syllabus"
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-bold text-slate-900">{PTB_CLASS1_ISLAMIAT.length}</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
