...
import { PTB_CLASS2_ENGLISH, getAllChapters } from "@/data/syllabus/ptb-class2-english";

/**
 * Class 2 English Syllabus Demo Page
 * 
 * Demonstrates the Chapter Selector with PTB Class 2 English.
 */
...
export function SyllabusClass2EnglishDemoPage() {
  ...
  return (
    <SchoolShell eyebrow="Question Papers" title="Class 2 English - Chapter Selection">
      <div className="space-y-6">
        ...
        <div className="p-4 bg-blue-50/50 border border-blue-100/50 rounded-xl">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[11px] font-bold text-blue-900 mb-1">Class 2 English Syllabus</p>
              <p className="text-[10px] text-blue-700 leading-relaxed">
                This syllabus includes all 12 units, 4 reviews, and English B section from PTB Class 2 English.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              <ChapterSelector
                units={PTB_CLASS2_ENGLISH}
                selectedChapters={selectedChapters}
                onSelectionChange={setSelectedChapters}
                title="PTB Class 2 English Syllabus"
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-bold text-slate-900">{PTB_CLASS2_ENGLISH.length}</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
