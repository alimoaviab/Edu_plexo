...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (24).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-tarjuma-quran.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_tarjuma_quran_inter2.sql');
...
const SUBJECT_ID = 'gsub_tarjuma_quran_ptb_global_inter2';
const SUBJECT_NAME = 'Tarjuma Tul Quran';
const SYLLABUS = 'ptb';
...
const topicMap = {
  "4": { id: "4", title: "Surah Al-Nisa" },
  "5": { id: "5", title: "Surah Al-Ma'idah" },
  "6": { id: "6", title: "Surah Al-Nur" },
  "7": { id: "7", title: "Surah Al-Ahzab" },
  "8": { id: "8", title: "Surah Muhammad" },
  "9": { id: "9", title: "Surah Al-Fath" },
  "10": { id: "10", title: "Surah Al-Hujurat" },
  "11": { id: "11", title: "Surah Al-Hadid" },
  "12": { id: "12", title: "Surah Al-Mujadilah" },
  "13": { id: "13", title: "Surah Al-Hashr" },
  "14": { id: "14", title: "Surah Al-Mumtahanah" },
  "15": { id: "15", title: "Surah Al-Saff" },
  "16": { id: "16", title: "Surah Al-Jumu'ah" },
  "17": { id: "17", title: "Surah Al-Munafiqun" },
  "18": { id: "18", title: "Surah Al-Taghabun" },
  "19": { id: "19", title: "Surah Al-Talaq" },
  "20": { id: "20", title: "Surah Al-Tahrim" }
};
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    const topicNum = match ? match[1] : (q.TopicRef ? q.TopicRef.trim() : '4');
    ...
    processedQuestions.push({
      _id: 'q_global_tarjuma_2_' + q.QuestionID,
