...
const srcPath = '/Users/ali/Desktop/EDUEXPLO/pts_complete_subject_data (4).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-physics.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_physics_inter2.sql');
...
const SUBJECT_ID = 'gsub_physics_ptb_global_inter2';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    const topicRef = q.TopicRef ? q.TopicRef.trim() : '12.1';
    ...
    processedQuestions.push({
      _id: `q_global_phy2_${q.QuestionID}`,
...
let sqlContent = `
-- Seed Physics Questions for PTB Class Inter 2
-- Generated on ${new Date().toISOString()}

BEGIN;

-- Delete old seeds if any
DELETE FROM questions WHERE school_id = '__global__' AND id LIKE 'q_global_phy2_%';
