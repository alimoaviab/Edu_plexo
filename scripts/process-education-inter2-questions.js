...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (17).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-education.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_education_inter2.sql');
...
const SUBJECT_ID = 'gsub_education_ptb_global_inter2';
const SUBJECT_NAME = 'Education';
const SYLLABUS = 'ptb';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_edu2_${q.QuestionID}`,
