...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (13).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-commercial-geography.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_commercial_geography_inter2.sql');
...
const SUBJECT_ID = 'gsub_commercial_geography_ptb_global_inter2';
const SUBJECT_NAME = 'Commercial Geography';
const SYLLABUS = 'ptb';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_geog2_${q.QuestionID}`,
...
let sqlContent = `
-- Seed Commercial Geography Questions for PTB Class Inter 2
-- Generated on ${new Date().toISOString()}

BEGIN;

-- Delete old seeds if any
DELETE FROM questions WHERE school_id = '__global__' AND id LIKE 'q_global_geog2_%';
