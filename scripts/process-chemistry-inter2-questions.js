...
const srcPath = '/Users/ali/Desktop/EDUEXPLO/pts_complete_subject_data (3).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-chemistry.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_chemistry_inter2.sql');
...
const SUBJECT_ID = 'gsub_chemistry_ptb_global_inter2';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_chem2_${q.QuestionID}`,
...
let sqlContent = `
-- Seed Chemistry Questions for PTB Class Inter 2
-- Generated on ${new Date().toISOString()}

BEGIN;

-- Delete old seeds if any
DELETE FROM questions WHERE school_id = '__global__' AND id LIKE 'q_global_chem2_%';
