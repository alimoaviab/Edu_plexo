...
const srcPath = '/Users/ali/Desktop/EDUEXPLO/pts_complete_subject_data (2).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-biology.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_biology_inter2.sql');
...
const SUBJECT_ID = 'gsub_biology_ptb_global_inter2';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    const topicRef = q.TopicRef ? q.TopicRef.trim() : '15.1';
    ...
    processedQuestions.push({
      _id: `q_global_bio2_${q.QuestionID}`,
