...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (30).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-library-science.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_library_science_inter2.sql');
...
const SUBJECT_ID = 'gsub_library_science_ptb_global_inter2';
const SUBJECT_NAME = 'Library Science';
const SYLLABUS = 'ptb';
...
const topicMap = {
  "1": { id: "1", title: "Classification" },
  "2": { id: "2", title: "Cataloguing" },
  "3": { id: "3", title: "Use of Reference Books" },
  "4": { id: "4", title: "Issue of Library Material" }
};
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: 'q_global_library_science_2_' + q.QuestionID,
