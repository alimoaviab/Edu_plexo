...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (29).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-insani-geography.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_insani_geography_inter2.sql');
...
const SUBJECT_ID = 'gsub_insani_geography_ptb_global_inter2';
const SUBJECT_NAME = 'Human Geography';
const SYLLABUS = 'ptb';
...
const topicMap = {
  "1": { id: "1", title: "Human Geography" },
  "2": { id: "2", title: "World Population" },
  "3": { id: "3", title: "Human Settlements" },
  "4": { id: "4", title: "Economic Activities" },
  "5": { id: "5", title: "Political Geography" },
  "6": { id: "6", title: "Natural Disasters" }
};
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: 'q_global_insani_geography_2_' + q.QuestionID,
