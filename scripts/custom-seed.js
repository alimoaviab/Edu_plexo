...
const schoolAdminEmail = "school@gmail.com";
...
async function main() {
  ...
  try {
    ...
    // UpdatePackages omitted because plan_premium grants full access and avoids a backend sync bug
  } catch (err) {
  ...
  try {
    ...
    console.log("→ Waiting 2s for backend async db flush...");
