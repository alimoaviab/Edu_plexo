...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (28).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-hadiqatul-adab.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_hadiqatul_adab_inter2.sql');
...
const SUBJECT_ID = 'gsub_hadiqatul_adab_ptb_global_inter2';
const SUBJECT_NAME = 'Arabic (Hadiqatul Adab)';
const SYLLABUS = 'ptb';
...
const topicMap = {
  "26": { id: "26", title: "Al-Sayyid Jamal al-Din al-Afghani" },
  "27": { id: "27", title: "Between Arab and Pakistani Witticisms" },
  "28": { id: "28", title: "Al-Rasa'il — Letter of Abu Bakr to Khalid ibn al-Walid" },
  "29": { id: "29", title: "Television" },
  "30": { id: "30", title: "In Love of the Homeland" },
  "31": { id: "31", title: "Rights of the People" },
  "32": { id: "32", title: "Pakistan — The Pure Land" },
  "33": { id: "33", title: "At the Bank" },
  "34": { id: "34", title: "Muhammad ﷺ" },
  "35": { id: "35", title: "In Determination and High Ambition" },
  "36": { id: "36", title: "At the Hospital" },
  "37": { id: "37", title: "From the Guidance of the Holy Quran" },
  "38": { id: "38", title: "The Arab States" },
  "39": { id: "39", title: "His Majesty King Faisal the Great" },
  "40": { id: "40", title: "In Description of Nature" },
  "41": { id: "41", title: "At the Railway Station" },
  "42": { id: "42", title: "Comprehensive Words" },
  "43": { id: "43", title: "Sermon of Umar ibn Abd al-Aziz" },
  "44": { id: "44", title: "Cricket Match" },
  "45": { id: "45", title: "In Virtue of Truthfulness and Earnest Work" },
  "46": { id: "46", title: "From the Guidance of the Holy Quran" },
  "47": { id: "47", title: "Bride of the Mountains — Murree Hill Station" },
  "48": { id: "48", title: "Virtue of Knowledge, Justice and Eating Halal" },
  "49": { id: "49", title: "At the Car Park" },
  "50": { id: "50", title: "In Helping the Destitute" }
};
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    let topicNum = match ? match[1] : (q.TopicRef ? q.TopicRef.trim() : '26');
    
    // Manual fallback for ". اَلدُّوَلَ الْعَرَبیَّۃُ"
    if (!match && topicNameRaw.includes('الْعَرَبیَّۃُ')) {
        topicNum = '38';
    }
    ...
    processedQuestions.push({
      _id: 'q_global_hadiqatul_adab_2_' + q.QuestionID,
