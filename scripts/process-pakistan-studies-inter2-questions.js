...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (15).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-pakistan-studies.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_pakistan_studies_inter2.sql');
...
const SUBJECT_ID = 'gsub_pak_studies_ptb_global_inter2';
const SUBJECT_NAME = 'Pakistan Studies';
const SYLLABUS = 'ptb';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_pst2_${q.QuestionID}`,
