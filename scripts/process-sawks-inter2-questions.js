...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (18).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-sawks.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_sawks_inter2.sql');
...
const SUBJECT_ID = 'gsub_sawks_ptb_global_inter2';
const SUBJECT_NAME = 'Civics';
const SYLLABUS = 'ptb';
...
const chapterMap = {
  "1": "Pakistan Movement",
  "2": "Constitutional Development 1947-73",
  "3": "Social Services in Pakistan",
  "4": "Social Discipline in Pakistan",
  "5": "National Unity and Integrity",
  "6": "Islamic Republic of Pakistan and the World"
};
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    const topicRef = q.TopicRef ? q.TopicRef.trim() : '1';
    const chInfo = { id: topicRef, title: chapterMap[topicRef] || q.TopicName || `Chapter ${topicRef}` };
    ...
    processedQuestions.push({
      _id: `q_global_sawks2_${q.QuestionID}`,
...
let sqlContent = `-- Seed Civics (Sawks) Questions for PTB Class Inter 2
