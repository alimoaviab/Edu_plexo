...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (14).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter1-statistics.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_statistics_inter1.sql');
...
const CLASS_ID = 'gcls_inter1_global';
const CLASS_NAME = 'INTER 1';
const SUBJECT_ID = 'gsub_statistics_ptb_global_inter1';
const SUBJECT_NAME = 'Statistics';
const SYLLABUS = 'ptb';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_stat1_${q.QuestionID}`,
