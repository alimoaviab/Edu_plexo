...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (7).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-statistics.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_statistics_inter2.sql');
...
const SUBJECT_ID = 'gsub_statistics_ptb_global_inter2';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_stat2_${q.QuestionID}`,
