...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (11).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-accounting.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_accounting_inter2.sql');
...
const SUBJECT_ID = 'gsub_accounting_ptb_global_inter2';
const SUBJECT_NAME = 'Principles of Accounting';
const SYLLABUS = 'ptb';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_acc2_${q.QuestionID}`,
