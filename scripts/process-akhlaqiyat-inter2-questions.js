...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (23).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-akhlaqiyat.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_akhlaqiyat_inter2.sql');
...
const SUBJECT_ID = 'gsub_akhlaqiyat_ptb_global_inter2';
const SUBJECT_NAME = 'Ethics (Akhlaqiyat)';
const SYLLABUS = 'ptb';
...
const topicMap = {
  "1.1 مذاہب کا تعارف": { id: "1.1", title: "Introduction to Religions" },
  "2.1 پاکستان میں مختلف مذاہب": { id: "2.1", title: "Different Religions in Pakistan" },
  "3.1 اخلاقی اقدار": { id: "3.1", title: "Moral Values" },
  "4.1 آداب": { id: "4.1", title: "Etiquettes" },
  "5.1 مشاہیر": { id: "5.1", title: "Notable Personalities" }
};
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: 'q_global_akhlaqiyat_2_' + q.QuestionID,
