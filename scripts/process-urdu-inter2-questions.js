...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (16).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-urdu.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_urdu_inter2.sql');
...
const SUBJECT_ID = 'gsub_urdu_ptb_global_inter2';
const SUBJECT_NAME = 'Urdu';
const SYLLABUS = 'ptb';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_urdu2_${q.QuestionID}`,
...
let sqlContent = `
-- Seed Urdu Questions for PTB Class Inter 2
-- Generated on ${new Date().toISOString()}

BEGIN;

-- Delete old seeds if any
DELETE FROM questions WHERE school_id = '__global__' AND id LIKE 'q_global_urdu2_%';
