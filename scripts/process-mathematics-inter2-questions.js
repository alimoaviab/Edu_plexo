...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (5).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-mathematics.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_mathematics_inter2.sql');
...
const SUBJECT_ID = 'gsub_mathematics_ptb_global_inter2';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_math2_${q.QuestionID}`,
