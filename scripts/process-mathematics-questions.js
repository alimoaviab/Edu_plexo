...
const srcPath = '/Users/ali/Desktop/EDUEXPLO/pts_complete_subject_data (1).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-one-mathematics.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_mathematics.sql');
...
const SUBJECT_ID = 'gsub_math_ptb_global_1'; // Auto-generated for global math
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_math_${q.QuestionID}`,
