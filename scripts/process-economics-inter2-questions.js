...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (9).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-economics.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_economics_inter2.sql');
...
const SUBJECT_ID = 'gsub_economics_ptb_global_inter2';
const SUBJECT_NAME = 'Economics';
const SYLLABUS = 'ptb';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_eco2_${q.QuestionID}`,
...
let sqlContent = `
-- Seed Economics Questions for PTB Class Inter 2
-- Generated on ${new Date().toISOString()}

BEGIN;

-- Delete old seeds if any
DELETE FROM questions WHERE school_id = '__global__' AND id LIKE 'q_global_eco2_%';
