...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (12).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-banking.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_banking_inter2.sql');
...
const SUBJECT_ID = 'gsub_banking_ptb_global_inter2';
const SUBJECT_NAME = 'Principles of Banking';
const SYLLABUS = 'ptb';
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: `q_global_bank2_${q.QuestionID}`,
