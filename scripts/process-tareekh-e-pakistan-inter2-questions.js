...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (31).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-tareekh-e-pakistan.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_tareekh_e_pakistan_inter2.sql');
...
const SUBJECT_ID = 'gsub_tareekh_e_pakistan_ptb_global_inter2';
const SUBJECT_NAME = 'History of Pakistan';
const SYLLABUS = 'ptb';
...
const topicMap = {
  "1": { id: "1", title: "Establishment of Pakistan and its Early Difficulties" },
  "2": { id: "2", title: "Political and Constitutional Development (1947-58)" },
  "3": { id: "3", title: "Era of Ayub Khan" },
  "4": { id: "4", title: "Martial Law of Yahya Khan" },
  "5": { id: "5", title: "Constitutional Crisis of 1971 and Separation of East Pakistan" },
  "6": { id: "6", title: "Era of People's Party Government" },
  "7": { id: "7", title: "Foreign Policy of Pakistan" },
  "8": { id: "8", title: "Era of Zia-ul-Haq's Government" }
};
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: 'q_global_tareekh_pakistan_2_' + q.QuestionID,
