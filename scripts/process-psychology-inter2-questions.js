...
const srcPath = '/Users/ali/Downloads/pts_complete_subject_data (25).json';
const outputDir = '/Users/ali/Desktop/EDUEXPLO/Eduplexo/data/questions';
const outputJsonPath = path.join(outputDir, 'ptb-inter2-psychology.json');
const outputSqlPath = path.join(outputDir, 'seed_questions_psychology_inter2.sql');
...
const SUBJECT_ID = 'gsub_psychology_ptb_global_inter2';
const SUBJECT_NAME = 'Psychology';
const SYLLABUS = 'ptb';
...
const topicMap = {
  "1.1 نشوونما کی نفسیات": { id: "1.1", title: "Psychology of Development" },
  "1.2 نشوونما کے نظریات": { id: "1.2", title: "Theories of Development" },
  "2.1 صحت کی نفسیات": { id: "2.1", title: "Health Psychology" },
  "2.2 فشار": { id: "2.2", title: "Stress" },
  "2.3 تشویشی امراض": { id: "2.3", title: "Anxiety Disorders" },
  "2.4 شیزوفرینیا": { id: "2.4", title: "Schizophrenia" },
  "2.5 طعامی امراض": { id: "2.5", title: "Eating Disorders" },
  "2.6 غذائی عادات بہتر بنانا": { id: "2.6", title: "Improving Dietary Habits" },
  "3.1 سماجی نفسیات": { id: "3.1", title: "Social Psychology" },
  "3.2 سماج دشمن کردار": { id: "3.2", title: "Anti-Social Behaviour" },
  "3.3 تعصب": { id: "3.3", title: "Prejudice" },
  "3.4 منشیات اور تمباکو نوشی": { id: "3.4", title: "Drugs and Smoking" },
  "3.5 تشدد": { id: "3.5", title: "Violence" },
  "3.6 صںفی امتیاز و جنسی ہراسانی": { id: "3.6", title: "Gender Discrimination and Sexual Harassment" },
  "3.7 رویہ اور رائے عامہ": { id: "3.7", title: "Attitude and Public Opinion" },
  "3.8 رائے عامہ": { id: "3.8", title: "Public Opinion" },
  "3.9 قیادت": { id: "3.9", title: "Leadership" },
  "4.1 رہنمائی اور مشاورت": { id: "4.1", title: "Guidance and Counselling" },
  "4.2 مشاورت کے طریقے": { id: "4.2", title: "Methods of Counselling" }
};
...
rawData.forEach(entry => {
  ...
  qList.forEach(q => {
    ...
    processedQuestions.push({
      _id: 'q_global_psychology_2_' + q.QuestionID,
