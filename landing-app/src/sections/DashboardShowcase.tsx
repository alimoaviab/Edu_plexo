...
export const DashboardShowcase = () => {
  ...
  return (
    <section id="dashboard" className="py-24 bg-white dark:bg-slate-900/40 overflow-hidden transition-colors duration-300" aria-labelledby="dashboard-heading">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/3">
            ...
            >
              ...
              <span className="text-blue-600 dark:text-sky-400">Maximum Clarity</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, x: -20 }}
              whileInView={{ opacity: 1, x: 0 }}
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-4 rounded-xl transition-all duration-300 text-left ${
                      isActive
                        ...
                        : "bg-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-200"
                    }`}
                  >
                    <div className={`p-2 rounded-lg ${isActive ? "bg-white/20" : "bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300"}`}>
          ...
          <div className="w-full lg:w-2/3 relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-100 to-indigo-50 dark:from-sky-950/40 dark:to-blue-900/20 rounded-[2.5rem] transform translate-x-4 translate-y-4 -z-10" />

            <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 rounded-[2rem] shadow-2xl overflow-hidden aspect-[4/3] md:aspect-[16/10] relative flex flex-col">
               {/* Browser Header Fake */}
               <div className="border-b border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-950 flex flex-col z-20 shrink-0">
                 {/* Top Tab Bar Row */}
                 <div className="h-10 flex items-center px-4 gap-4">
                   ...
                   <div className="flex items-center gap-1.5">
                     <div className="flex items-center bg-white dark:bg-slate-900 border-t border-x border-slate-200/80 dark:border-slate-700/80 rounded-t-lg px-4 h-8 text-[11px] font-bold text-slate-800 dark:text-slate-200 shadow-sm whitespace-nowrap">
                       <span>EduPlexo — {tabs[activeTab].label}</span>
                       <button className="ml-2 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 rounded-full p-0.5 transition-colors">
                         <svg className="w-2.5 h-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
                       </button>
                     </div>
                     {/* New tab plus button */}
                     <button className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 p-1 hover:bg-slate-200/60 dark:hover:bg-slate-800 rounded transition-colors shrink-0">
                 ...
                 {/* URL Bar Row */}
                 <div className="h-9 bg-white dark:bg-slate-900 border-t border-slate-200/80 dark:border-slate-800 flex items-center px-4 gap-3">
                   {/* Nav buttons */}
                   <div className="flex items-center gap-2 text-slate-400 dark:text-slate-500 shrink-0">
                     ...
                     <svg className="w-3.5 h-3.5 hover:text-slate-600 dark:hover:text-slate-300 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" /></svg>
                   </div>
                   
                   {/* Address Input */}
                   <div className="flex-1 bg-slate-100 dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700/60 rounded-md h-6 px-3 flex items-center gap-1.5 text-[11px] text-slate-600 dark:text-slate-300 select-none">
                     ...
                     <span className="font-semibold text-emerald-700 dark:text-emerald-400">https://</span>
                     <span className="font-medium text-slate-700 dark:text-slate-300">eduplexo.com/admin/{tabs[activeTab].id === "admin" ? "dashboard" : tabs[activeTab].id === "ai" ? "ai-assistant" : tabs[activeTab].id}</span>
                   </div>
                 </div>
               </div>
                   ...
                   >
                     <img
                       ...
                       className={`w-full h-full border-none ${
                         tabs[activeTab].id === "ai" ? "object-contain p-4 bg-slate-50 dark:bg-slate-900" : "object-cover object-top"
                       }`}
                       loading="lazy"
                       width="800"
                       height="600"
