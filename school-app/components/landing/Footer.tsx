        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#dashboard" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">Platform</Link></li>
              <li><Link href="#security" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">Security</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">Careers</Link></li>
              <li><Link href="#" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">Blog</Link></li>
              <li><Link href="#" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
