...
export const WhyChooseUsSection = () => {
  const points = [
    {
      ...
      description: "Built on Next.js, our platform guarantees sub-second load times. No more waiting for reports to generate or pages to load.",
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-bl from-blue-50 to-transparent rounded-full blur-3xl opacity-50 -translate-y-1/2 translate-x-1/3 pointer-events-none" />
          ...
          <div className="w-full lg:w-1/2">
             ...
             >
                ...
                <div className="bg-slate-900 rounded-3xl p-8 md:p-12 relative shadow-2xl overflow-hidden">
                   ...
                   <h3 className="text-2xl font-bold text-white mb-8">The EduManage Difference</h3>
                   ...
                   <div className="mt-12 pt-8 border-t border-white/10 flex items-center justify-between">
                     ...
                     <div>
                       <div className="text-white text-3xl font-bold">&lt; 1hr</div>
                       <div className="text-slate-400 text-sm">Support Response</div>
                     </div>
                   </div>
                </div>
             </motion.div>
