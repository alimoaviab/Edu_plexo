      ...
      <div className="space-y-8">
        <section className="rounded-[2rem] bg-gradient-to-r from-slate-950 via-slate-900 to-violet-900 p-8 text-white shadow-2xl shadow-slate-950/20">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <p className="text-xs font-semibold normal-case tracking-[0.35em] text-violet-200/80">Exam portal</p>
              <h1 className="mt-3 text-3xl font-bold tracking-tight md:text-5xl">Join Live Exams</h1>
            ...
            <div className="rounded-2xl bg-white/10 px-5 py-4 backdrop-blur-md">
              <p className="text-xs font-semibold normal-case tracking-[0.25em] text-violet-100/70">Exam readiness</p>
              ...
              {loading ? (
                ...
                <div className="rounded-3xl border border-slate-200 p-4 shadow-sm">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold normal-case text-slate-600">Waiting</span>
                  </div>
                </div>
              ) : (
                exams.map((exam) => (
