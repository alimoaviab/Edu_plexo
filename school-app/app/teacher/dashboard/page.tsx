          ...
          <div className="space-y-5">
            ...
            <section className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
              <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between">
                ...
                <Link href="/teacher/timetable" className="text-[10px] font-bold text-blue-600 hover:underline">View Full Schedule</Link>
              </div>
                    ...
                    <div className="flex items-center gap-2">
                      {!task.attendance_marked ? (
                        <Button size="sm" variant="primary" className="h-7 px-3 text-[10px] font-bold rounded-lg">
                          <Link href={`/teacher/attendance/create?class=${task.id}`}>Mark Attendance</Link>
                        </Button>
                      ) : (
            ...
            <section className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Link href="/teacher/classes" className="text-[10px] font-bold text-blue-600 hover:underline">Manage All</Link>
              </div>
  ...
  return (
    <div className={`p-3 border rounded-xl flex items-start gap-3 shadow-sm ${colors[priority]}`}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <Link href={action} className="text-[9px] font-black uppercase tracking-widest hover:underline flex items-center gap-1">
