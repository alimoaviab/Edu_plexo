    ...
    <SchoolShell title="Schedule Live Exam" eyebrow="Admin">
      <div className="mx-auto max-w-4xl space-y-6 pb-12">
        <div className="flex items-center gap-4">
          <Link href="/teacher/live-exam" className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-500 hover:bg-slate-50 transition-colors shadow-sm">
        ...
        <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mt-8 flex justify-end gap-3 pt-6 border-t border-slate-100">
              <Link href="/teacher/live-exam" className="rounded-xl px-6 py-3 font-semibold text-slate-600 hover:bg-slate-100 transition-colors">
                Cancel
              </Link>
