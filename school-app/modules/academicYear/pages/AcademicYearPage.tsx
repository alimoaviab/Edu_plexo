    ...
    return (
        <div className="flex flex-col gap-4">
                ...
                actions={
                    <div className="flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-2.5 py-1.5 shadow-sm">
                        <div className="flex flex-col">
                            <span className="text-[10px] font-semibold normal-case tracking-[0.14em] text-slate-500">Active</span>
                            <span className="text-sm font-semibold text-slate-950">{activeYear?.year ?? "None"}</span>
                        </div>
                        <div className="h-8 w-px bg-slate-200" />
                        <div className="flex flex-col">
                            <span className="text-[10px] font-semibold normal-case tracking-[0.14em] text-slate-500">Total</span>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
                <Card className="p-3">
                    <span className="text-[10px] font-bold normal-case tracking-[0.16em] text-slate-400">Configured years</span>
                    <div className="mt-1.5 flex items-end justify-between gap-3">
                        <div>
                            <div className="text-xl font-bold tracking-tight text-slate-900">{years.length}</div>
                ...
                <Card className="p-3">
                    <span className="text-[10px] font-bold normal-case tracking-[0.16em] text-slate-400">Active session</span>
                    <div className="mt-1.5 flex items-end justify-between gap-3">
                        <div>
                            <div className="text-xl font-bold tracking-tight text-slate-900">{activeYear?.year ?? "None"}</div>
                ...
                <Card className="p-3">
                    <span className="text-[10px] font-bold normal-case tracking-[0.16em] text-slate-400">Completed</span>
                    <div className="mt-1.5 flex items-end justify-between gap-3">
                        <div>
                            <div className="text-xl font-bold tracking-tight text-slate-900">{completedYears}</div>
