    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm">
        <div className="flex items-center gap-4 mb-6">
          <Link href={role === "ADMIN" ? "/admin/exams" : "/teacher/exams"} className="h-10 w-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-slate-100 transition-all">
